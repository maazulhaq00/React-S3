...
function StudentDetail(props) {
    ...
    // let data = props.student
    let {name, title, email, contact} = props.student
    ...
    return (<>
      <div className="col-sm-4 mb-3 mb-sm-0">
        ...
        <div className="card" style={{ width: "18rem" }}>
            <div className="card-body">
                <h5 className="card-title">{name ?? "Not Provided"}</h5>
                <h6 className="card-subtitle mb-2 text-body-secondary">{title ?? "Not Provided"}</h6>
                <p className="card-text">
                    <b>Email:</b> {email ?? "Not Provided"} <br />
